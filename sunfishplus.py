...
def main(diff):
    ...
    while True:
        ...
        move, score = searcher.search(pos, secs=diff/2)
...
if __name__ == '__main__':
    while(1):
        difficulty = input("What difficulty would you like to play, from 1 to 10?")
        difficulty = int(difficulty)
        if (difficulty < 1 or difficulty > 10):
            print("Invalid Input")
            continue
        choice = input("Would you like to play as black or white?")
        if (choice == "black" or choice == "Black"):
            main_black(difficulty)
        elif (choice == "white" or choice == "White"):
            main(difficulty)
        else:
            print("Invalid Input")
            continue
